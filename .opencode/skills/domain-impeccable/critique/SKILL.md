...
Load the base design skill:

```bash
skill "frontend-design"
```

It contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding — if no design context exists yet, run `/teach-impeccable` first. Additionally gather: what the interface is trying to accomplish.
...
> *Consult the **cognitive-load** section (in the frontend-design skill) for the working memory rule and 8-item checklist*
...
### Design Health Score
> *Consult the **heuristics-scoring** section (in the frontend-design skill)*
...
For each issue, tag with **P0–P3 severity** (consult the **heuristics-scoring** section (in the frontend-design skill) for severity definitions):
- **[P?] What**: Name the problem clearly
- **Why it matters**: How this hurts users or undermines goals
- **Fix**: What to do about it (be concrete)
- **Suggested command**: Which command could address this (from: /animate, /arrange, /critique, /extract, /polish, /optimize, /audit, /typeset, /bolder, /clarify, /delight, /adapt, /colorize, /quieter, /harden, /distill, /onboard, /normalize, /overdrive)

### Persona Red Flags
> *Consult the **personas** section (in the frontend-design skill)*
...
- Only recommend commands from: /animate, /arrange, /critique, /extract, /polish, /optimize, /audit, /typeset, /bolder, /clarify, /delight, /adapt, /colorize, /quieter, /harden, /distill, /onboard, /normalize, /overdrive
