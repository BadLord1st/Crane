...
It contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding — if no design context exists yet, run `/teach-impeccable` first. Additionally gather: audience technical level and users' mental state in context.
